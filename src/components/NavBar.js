...
function NavBar(argument) {
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="#"> <img src={img1} width="60" height="40" alt="News Line"/></a>
    ...
    <div class="collapse navbar-collapse " id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0 ">
        ...
        <li class="nav-item">
          <Link to="/detail" class="nav-link" >World</Link>
        </li>
          <li class="nav-item">
...
<h1 className='nav-sub'>News Line</h1></div>)
